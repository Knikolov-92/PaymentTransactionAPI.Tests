...
namespace PaymentTransactionAPI.Tests.TestInfrastructure.Constants
{
    public static class ExpectedResponses
    {
        ...
        public const string PAYMENT_TRANSACTION_DECLINED_STATUS = "declined";
        ...
        public const string PAYMENT_TRANSACTION_DECLINED_MESSAGE = "Your transaction has been declined.";
